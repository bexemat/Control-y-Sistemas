 ...
 *
 *         double y1=PID(double u1,double u2,double u3,double u4,double u5,double u6)
 *
 *    Simulink version           : 10.2 (R2020b) 29-Jul-2020
 *    C source code generated on : 22-Dec-2022 11:28:07
 *
...
#define S_FUNCTION_NAME  PIDiscreto
